...
export interface FireballsPageClientProps {
  initialData: EventStreamResult<FireballEvent> | null;
  initialError: string | null;
  initialFetchKey: string;
}

function buildFireballsFetchKey(filters: FireballFilters): string {
  const params = new URLSearchParams();
  if (filters.reqLoc) params.set("reqLoc", "true");
  if (filters.reqAlt) params.set("reqAlt", "true");
  if (filters.reqVel) params.set("reqVel", "true");
...
export function FireballsPageClient({
  initialData,
  initialError,
  initialFetchKey,
}: FireballsPageClientProps) {
  ...
  const filters: FireballFilters = useMemo(
    () => ({
      reqLoc,
      reqAlt,
      reqVel,
