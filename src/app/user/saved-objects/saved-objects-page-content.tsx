              ...
              <div className="grid gap-3 md:grid-cols-2">
                {filteredItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="group relative overflow-hidden rounded-xl border border-border/50 bg-card/95 p-4 shadow-[inset_0_1px_0_rgba(255,210,160,0.06)] transition duration-300 hover:border-orange-300/40"
                    >
