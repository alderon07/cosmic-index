...
func TestSearchStarsColumnsMixedCaseAndOrder(t *testing.T) {
	t.Parallel()
	...
	if !strings.Contains(header, "NAME") || !strings.Contains(header, "ID") || strings.Contains(header, "PLANETS") {
